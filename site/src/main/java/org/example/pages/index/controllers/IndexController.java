...
import org.example.pages.index.IndexService;
import org.example.pages.index.Validation;
...
public class IndexController {
  ...
  public String
      ...
      groups(HttpServletRequest request, Model model, final RedirectAttributes redirectAttributes) {
    return "groups";
  }
